...
좌석이 1일때부터 늘려가면서 자리를 옮기는 경우의 수를 계산하면 피보나치 수열임을 알 수 있다.

피보나치를 구하는 함수를 DP로 구현하고, VIP석들 사이에 거리만큼을 피보나치 파라미터로 넘겨주면 된다.

VIP석이 처음일 경우와 마지막일 경우를 예외처리 해야한다.
